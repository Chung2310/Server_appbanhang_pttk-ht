...
if ($email && $pass && $name && $sdt && $chucvu) {
    ...
    if ($numrow > 0) {
        ...
        $query = "INSERT INTO `user`(`email`, `pass`, `name`, `sdt`, `chucvu`) VALUES (?, ?, ?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "sssss", $email, $hashed_pass, $name, $sdt, $chucvu);
